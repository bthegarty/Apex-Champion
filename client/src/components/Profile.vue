<template>
    <section>
        ...
        <div v-if="profileData" class="container">
            <h1 class="gamertag">
                <img :src="profileData.platformInfo.avatarUrl" alt="Legends" class="platform-avatar" />
                    ...
                    <ul>
                        ...
                        <li v-if="profileData.segments[0].stats.kills">
                            ...
                            <p>
                                ...
                                <span v-if="profileData.segments[0].stats.kills === 0">({{ profileData.segments[0].stats.kills.percentile }}%)</span>
                            </p>
                        </li>
                        <li v-if="profileData.segments[0].stats.damage">
                            ...
                            <p>
                                ...
                                <span v-if="profileData.segments[0].stats.damage === 0">({{ profileData.segments[0].stats.damage.percentile }}%)</span>
                            </p>
                        </li>
                    </ul>
                </div>
